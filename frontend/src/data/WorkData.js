...
export const Work = [
    {
        id:1,
        name:"Cosmic Library",
        description:"Cosmic Library is a 3D immersive eBook platform inspired by the Akashic Records, allowing users to explore and read interactive books in a celestial environment.",
        tags:[" Vite, React, Three.js, Framer Motion, Styled Components,  Express, MongoDB, Node.js,Material UI, Vercel (Frontend), Render (Backend),  Cloudinary integration, secure auth, animated transitions, 3D interactive UI"],
        
        demo:"https://cosmic-library.onrender.com",
        github:"https://github.com/KarrmaAzan/Cosmic-Library/tree/main"
    },
    {
        id:2,
        name:"Karrma's Heart",
    ...
    },
    {
        id:3,
        name:"AJ's Smokeshop",
        description:"is a vibrant, animated smoke shop web app that combines immersive smoke effects, neon lighting, and a modern user experience. It features a built-in rewards system and real-time SMS notifications powered by Twilio, enhancing customer loyalty and engagement.  ",
        tags:[" React, Vite, React Router, Three.js, Framer Motion, CSS Animations,  Material UI, Node.js, Express, MongoDB,  Twilio"],
    ...
    },
    {
        ...
        demo:"https://mr-neighbor-eight.vercel.app/",
        github:"https://github.com/KarrmaAzan/Mr.Neighbor.git"
